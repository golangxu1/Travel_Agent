...
基于多 Agent 协作架构的智能旅行规划系统，输入出发地、目的地和旅行偏好，自动生成包含目的地概览、天气信息、住宿推荐、每日行程和预算明细的完整旅行方案。

![旅游助手界面](docs/images/旅游助手界面.png)
...
![旅行参数输入](docs/images/旅游助手界面.png)

### 目的地概览与景点地图

![目的地概览与景点地图](docs/images/效果1.png)

### 天气信息与出行建议

![天气信息与出行建议](docs/images/效果2.png)

### 住宿推荐（根据预算档次生成）

| 中高档住宿方案 | 经济型住宿方案 |
|:---:|:---:|
| ![中高档住宿方案](docs/images/贵的住宿.png) | ![经济型住宿方案](docs/images/更改后的住宿.png) |
